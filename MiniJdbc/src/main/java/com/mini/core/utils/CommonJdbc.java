...
public class CommonJdbc {
	 ...
	 * @throws SQLException
	 */
	public static Connection getConnection(String dialect, String ip, int port, String database,String userName, String password) throws SQLException {
	...
	public static void main(String[] args) throws Exception {
		Connection conn = getConnection(MYSQL,"10.10.10.7", 3306, "zhenai_sms", "u_96333", "u_96333");
