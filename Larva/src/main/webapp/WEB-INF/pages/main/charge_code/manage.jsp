...
<div class='modal hide fade' id='modal-charge-code' role='dialog' tabindex='-1'>
	    ...
	    <div class='modal-body'>
	        <div class='control-group'>
	            ...
	            <div class='controls'>
	                    ...
	                    <input class='span8' id='code_name' name="app_name" required placeholder='APP名称' type='text' />
	            </div>
	        </div>
	        <div class='control-group'>
	            <label class='control-label'>请求URL</label>
	            <div class='controls'>
	                <input class='span8' id='url' required name="app_package_name" placeholder='菜单名称' type='text' />
	            </div>
	        </div>
	         <div class='control-group'>
	            <label class='control-label'>请求内容</label>
	            <div class='controls'>
	                <input class='span8' id='charge_code' name="link_name" placeholder='菜单图片' type='text' />
	            </div>
	        </div>
	        <div class='control-group'>
