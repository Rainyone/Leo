package com.larva.ip2region.test;
...
import com.larva.ip2region.DbMakerConfigException;
...
public class TestUnit {
	...
	public static void main(String[] args) {
		try {
			DbSearcher _searcher = new DbSearcher(new DbConfig(), "H:/hongqiao/testcode/LarvaFrame/Larva-inf/src/main/resources/ip2region/ip2region.db");
			BufferedReader bfr   = new BufferedReader(new FileReader("H:/hongqiao/testcode/LarvaFrame/Larva-inf/src/main/resources/ip2region/ip.merge.txt"));
			BufferedWriter bwr   = new BufferedWriter(new FileWriter("H:/hongqiao/testcode/LarvaFrame/Larva-inf/src/main/resources/ip2region/error_log.txt", true));
			int errCount  = 0;
			int lineCount = 0;
			String str = null;
